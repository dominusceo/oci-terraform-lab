...
export TF_VAR_private_key_path="/home/ricardo.carrillo/.ssh/oci_api_private.pem"
export TF_VAR_api_private_key="/home/ricardo.carrillo/.ssh/oci_api_private.pem"
export TF_VAR_ssh_public_key=/home"/ricardo.carrillo/.ssh/oci_api_public.pem"
